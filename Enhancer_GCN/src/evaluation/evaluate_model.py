...
foldings_dataset = '../data/K562_200bp_fold.pkl'
...
model = GCN(n_features=opt.embedding_dim, hidden_dim=80, n_classes=n_classes,
            n_conv_layers=4,
            dropout=0.2, batch_norm=opt.batch_norm, num_embeddings=len(word_to_ix),
