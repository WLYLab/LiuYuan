...
parser.add_argument('--embedding_dim', type=int, default=20, help='Dimension of nucleotide '
                                                                  'embeddings')
parser.add_argument('--hidden_dim', type=int, default=40, help='Dimension of hidden '
...
parser.add_argument('--foldings_dataset', type=str,
                    default='../data/GM12878_com_big_than50_labeled.pkl', help='Path to foldings')
parser.add_argument('--train_dataset', type=str,
                    default='../data/GM12878_com_big_than50_real_train.fa', help='Path to training '
                                                                          'dataset')
parser.add_argument('--val_dataset', type=str,
                    default='../data/GM12878_com_big_than50_val.fa', help='Path to val dataset')
